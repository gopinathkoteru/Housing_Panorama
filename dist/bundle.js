...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  root.Transition.init("../test/panos-house/");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.9.3
	(function() {
	  var container, keyMax, keySpeed, onPointerDownLat, onPointerDownLon, onPointerDownPointerX, onPointerDownPointerY, on_key_down, on_key_up, on_mouse_down, on_mouse_move, on_mouse_up, on_mouse_wheel, root, touch_handler;
	      ...
	      while (i < 6) {
	        if (i === 5) {
	          TweenLite.to(Transition.clear_pano[Transition.pano_num].mesh.material.materials[i], time, {
	            opacity: 1,
	            ease: Power0.easeOut,
	            onComplete: root.Hotspot.add_hotspots,
...
/***/ function(module, exports) {
	...
	// Generated by CoffeeScript 1.9.3
	(function() {
	  var Config, animate, blur_images, camera, clear_images, detect_webgl, go_fullscreen, image_div, init, raycaster, renderer, root, rotate_camera, scene, texture_placeholder, update;
