	...
	(function() {
	  ...
	  Annotation = (function() {
	    ...
	    Annotation.prototype.add_annotation = function(annotation_id, top, left) {
	      ...
	      anno_div1.prepend("<img class='annotation' height='40px' width='40px' src='../test/images/info.png'></img> <div class='hotspot-title'> <div class='hotspot-text'>" + root.house[pano_id][ANNOTATIONS][anno_id][TITLE] + "</div> </div> <div class='info-hotspot'>" + root.house[pano_id][ANNOTATIONS][anno_id][DESC] + "</div>");
	      ...
	      anno_div2.prepend("<img class='annotation' height='40px' width='40px' src='../test/images/info.png'></img> <div class='hotspot-title'> <div class='hotspot-text'>" + root.house[pano_id][ANNOTATIONS][anno_id][TITLE] + "</div> </div> <div class='info-hotspot'>" + root.house[pano_id][ANNOTATIONS][anno_id][DESC] + "</div>");
	    ...
	    Annotation.prototype.add_annotations = function() {
	      ...
	      pano_id = this.pano_id;
	      this.length = root.house[pano_id][ANNOTATIONS].length;
	      i = 0;
	      while (i < this.length) {
