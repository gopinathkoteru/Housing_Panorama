...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  var adjust, animate, back_pano, camera, change_pano, container, fallback_image, front_pano, house_id, init, one_dataset, position, renderer, root, scene, slider, texture_placeholder, update;
	  ...
	  $("#xml-submit").on('click', function() {
	    var i, num_panos, xmlDoc, xml_scene, xmlhttp;
	  ...
	  $("#fallback-image-button").on('click', function() {
	...
	(function() {
	  ...
	  Pano = (function() {
	    ...
	    Pano.prototype.create_pano = function(opacity) {
	      var dfrd, geometry, i, j, material, num_slices, path, path1, slice, slices, texture;
	      ...
	      path1 = root.pano_paths[this.pano_id];
	      i = 0;
	      while (i < 6) {
	        j = 0;
