...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  var adjust, animate, back_pano, camera, change_pano, container, front_pano, full_dataset, hotspot, init, one_dataset, path, renderer, root, scene, slider, texture_placeholder, update;
	  ...
	  $('#save-hotspot-button').click(function() {
	    var angle, dict, error, from_id, i, pano_path, text, title, to_id;
	    if (full_dataset[$("#house-list").val()] === void 0) {
	      one_dataset = {};
	  ...
	  $("#save-all-hotspots-button").click(function() {
	    return localStorage.setItem('full_dataset', JSON.stringify(full_dataset));
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Generated by CoffeeScript 1.9.3
	(function() {
	  var angle, angle1, annotation_count, flag, lat, lon, onPointerDownLat, onPointerDownLon, onPointerDownPointerX, onPointerDownPointerY, root, uns_annotation, update;
	  ...
	  $("#save-annotation-button").on('click', function() {
