...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  var adjust, animate, back_pano, camera, change_pano, container, front_pano, hotspot, init, one_dataset, path, renderer, root, scene, slider, texture_placeholder, update;
	  ...
	  $("#save-data-button").click(function() {
	    var from_id, pano_path, title;
	    root.save_annotation();
	    root.save_hotspot();
	    if (root.full_dataset[$("#house-list").val()] === void 0) {
	      one_dataset = {};
	    ...
	    return localStorage.setItem('full_dataset', JSON.stringify(root.full_dataset));
	  });
